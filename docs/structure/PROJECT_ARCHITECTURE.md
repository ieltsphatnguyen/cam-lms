...
**Database Tables**
- `grading` — grading records (submission_id, status, grader)
...
**Architecture File**
`09_StudentDashboard_Architecture.md`
...
**Architecture File**
`10_TeacherDashboard_Architecture.md`
