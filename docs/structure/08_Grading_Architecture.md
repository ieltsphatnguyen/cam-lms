...
- `src/pages/teacher/TeacherGradingPage.tsx` — grading hierarchy + annotation workspace

## Components

- `src/components/annotations/AnnotationWorkspace.tsx` — embedded for individual attempt grading
...
| Table | Purpose |
|-------|---------|
| `grading` | Grading records (submission_id, grading_status, grader_id) |
| `student_attempts` | The submissions being graded |
...
| `publish_feedback` | Mark feedback as published |
