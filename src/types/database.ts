...
export type ItemStatus = 'locked' | 'available' | 'completed' | 'overdue' | 'revision_requested';

export const REVISION_REQUESTED: ItemStatus = 'revision_requested';
...
export interface PublishedScoreSnapshot {
  id: number;
  criterion_id: number;
