...
import { ArrowLeft, FileText, Mic, Clock, CheckCircle2 } from 'lucide-react';
import Button from '@/components/ui/Button';
import LoadingSpinner from '@/components/ui/LoadingSpinner';
import { fetchAttemptForItem } from '@/lib/attempts';
import { fetchStudentFeedback, getAudioCommentUrl, fetchPublishedAnnotations, fetchPublishedTextFormats, fetchRubricCriteria } from '@/lib/annotations';
    ...
    async function load() {
      try {
        ...
        if (data) {
          ...
          try {
            const [annData, tfData] = await Promise.all([
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          {loading ? (
            ...
            <>
              ...
              {/* Feedback section (only if published) */}
              {feedbackPublished ? (
